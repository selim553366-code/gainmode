...
export const styles = StyleSheet.create({
  ...
  featurePill: { minHeight: 44, borderRadius: 15, borderWidth: 1, paddingHorizontal: 9, flexDirection: 'row', alignItems: 'center', gap: 4 },
  ...
  premiumPill: { minHeight: 44, borderRadius: 15, borderWidth: 1, paddingHorizontal: 10, flexDirection: 'row', alignItems: 'center', gap: 5 },
  ...
  lockPreviewShade: { ...StyleSheet.absoluteFill, backgroundColor: '#020B1859' },
