...
const formImages: Record<FormKind, ImageSourcePropType> = {
  push: require('@/assets/images/live-guide-coach-pushup-oblique-skeleton.png'),
  squat: require('@/assets/images/live-guide-coach-squat-oblique-skeleton.png'),
  lunge: require('@/assets/images/live-guide-coach-lunge-oblique-skeleton.png'),
