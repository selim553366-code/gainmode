...
const styles = StyleSheet.create({
  ...
  liveAnalysisCard: { width: '100%', minHeight: 188, borderRadius: 20, borderWidth: 1, marginTop: 10, padding: 12, overflow: 'hidden' },
  liveAnalysisHeader: { flexDirection: 'row', alignItems: 'flex-start', gap: 10 },
  ...
  liveAnalysisBody: { fontFamily: 'Inter_400Regular', fontSize: 11, lineHeight: 15, marginTop: 7 },
  liveChoiceRow: { flexDirection: 'row', gap: 7, marginTop: 17 },
  liveChoice: { flex: 1, minHeight: 44, borderRadius: 14, borderWidth: 1, alignItems: 'center', justifyContent: 'center', flexDirection: 'row', gap: 4, paddingHorizontal: 3 },
