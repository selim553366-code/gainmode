...
const styles = StyleSheet.create({
  ...
  coachTabButton: { position: 'absolute', top: -30, alignItems: 'center', shadowOpacity: 0.5, shadowRadius: 18, shadowOffset: { width: 0, height: 4 }, elevation: 18 },
  coachTabCircle: { width: 68, height: 68, borderRadius: 34, borderWidth: 3, alignItems: 'center', justifyContent: 'center', overflow: 'hidden', shadowOpacity: 0.42, shadowRadius: 14, shadowOffset: { width: 0, height: 0 }, elevation: 13 },
  coachTabImage: { width: 68, height: 68, borderRadius: 34 },
  coachThinkingImage: { width: 76, height: 76, transform: [{ translateY: 4 }] },
  coachThinkingOverlay: { position: 'absolute', left: -4, top: -4 },
  coachTabLabel: { fontFamily: 'Inter_700Bold', fontSize: 11, marginTop: 5, letterSpacing: 0.8 },
