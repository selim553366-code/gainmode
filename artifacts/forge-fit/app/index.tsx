...
const styles = StyleSheet.create({
  ...
  entryRecoveryButtonText: { fontFamily: 'Inter_700Bold', fontSize: 13 },
   questionTop: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingTop: 0, paddingLeft: 14, paddingRight: 14, transform: [{ translateY: -4 }] },
  ...
  onboardingBlobCyan: { width: 300, height: 360, bottom: -70, right: -90 },
   questionBody: { flex: 1, minHeight: 0, marginTop: 0 },
