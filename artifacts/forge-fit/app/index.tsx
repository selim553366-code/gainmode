...
const styles = StyleSheet.create({
  ...
  welcomeCardGlow: { position: 'absolute', width: 260, height: 260, top: 40, borderRadius: 130, alignSelf: 'center' },
   welcomeCharacterStage: { width: 260, height: 260, marginTop: 28, borderRadius: 130, overflow: 'visible', alignSelf: 'center', alignItems: 'center', justifyContent: 'center' },
   welcomeReferenceCharacter: { width: '100%', height: '100%' },
