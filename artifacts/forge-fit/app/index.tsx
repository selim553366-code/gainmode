...
const styles = StyleSheet.create({
  ...
  questionScrollContent: { paddingTop: 2, paddingBottom: 12 },
   coachQuestionVisual: { width: '100%', height: 342, alignSelf: 'center', alignItems: 'center', justifyContent: 'flex-start', marginBottom: 8 },
  ...
  profileEditInfoText: { flex: 1, fontFamily: 'Inter_500Medium', fontSize: 11, lineHeight: 17 },
   coachPhotoStage: { width: 300, height: 300, alignItems: 'center', justifyContent: 'center' },
  coachSmall: { width: 238, height: 238 },
   coachOnboarding: { width: 300, height: 300 },
  ...
  welcomeCardGlow: { position: 'absolute', width: 260, height: 260, top: 30, borderRadius: 130, alignSelf: 'center' },
   welcomeCharacterStage: { width: 260, height: 260, marginTop: 18, borderRadius: 130, overflow: 'visible', alignSelf: 'center', alignItems: 'center', justifyContent: 'center' },
   welcomeReferenceCharacter: { width: '90%', height: '90%' },
