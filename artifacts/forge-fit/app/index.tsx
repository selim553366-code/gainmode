...
const styles = StyleSheet.create({
  ...
  questionScrollContent: { paddingTop: 2, paddingBottom: 12 },
   coachQuestionVisual: { width: '100%', height: 322, alignSelf: 'center', alignItems: 'center', justifyContent: 'flex-start', marginBottom: 8 },
  ...
  profileEditInfoText: { flex: 1, fontFamily: 'Inter_500Medium', fontSize: 11, lineHeight: 17 },
   coachPhotoStage: { width: 280, height: 280, alignItems: 'center', justifyContent: 'center' },
  coachSmall: { width: 238, height: 238 },
   coachOnboarding: { width: 280, height: 280 },
