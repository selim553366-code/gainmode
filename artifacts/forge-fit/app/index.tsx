...
const styles = StyleSheet.create({
  ...
  welcomeCardGlow: { position: 'absolute', width: 260, height: 260, top: 22, borderRadius: 130, alignSelf: 'center' },
   welcomeCharacterStage: { width: 260, height: 260, marginTop: 10, borderRadius: 130, overflow: 'hidden', alignSelf: 'center', alignItems: 'center', justifyContent: 'center' },
